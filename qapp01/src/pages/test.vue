          ...
          <q-tab-panels v-model="tab" animated class="bg-white">
            <q-tab-panel name="all" class="q-pa-none full-height" :style="{'height':size['height']-80+'px !important'}">
              <q-list class="">
                ...
                <q-item clickable v-ripple v-for="(contact, index) in contacts_list" :key="index" @click="selected_contact=contact">
            ...
            <q-tab-panel name="favorites" class="q-pa-none" :style="{'height':size['height']-80+'px !important'}">
              <q-list class="">
                ...
                <q-item clickable v-ripple v-for="(favorite, index) in favorites_list" :key="index">
                  <q-item-section avatar>
                    <q-avatar>
